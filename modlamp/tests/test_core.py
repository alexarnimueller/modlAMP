...
class TestCore(unittest.TestCase):
	sequences = ['GLFDIVKKVVGALG', 'GLFDIVKKVVGALG', 'GLFDIVKKVVGALK', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'AGGURST']
	r = Random(10, 20, 1)
	...
	def test_filter_unnatural(self):
		...
		self.assertNotIn(['ABCDEFGHIJKLMNOPQRSTUVWXYZ','AGGURST'], self.r.sequences)
